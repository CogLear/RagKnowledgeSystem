  ...
  return (
    <label className="neo-checkbox">
      <input
        ...
        className="sr-only"
      />
      <span className={`neo-checkbox-box ${checked ? "checked" : ""}`}>
        {checked && (
    ...
    <div className="relative flex min-h-screen items-center justify-center px-4">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 font-medium">检索增强生成智能问答平台</p>
        </div>
          ...
          <form className="space-y-5" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-3 cursor-pointer">
                <NeoCheckbox checked={remember} onChange={setRemember} />
                <span className="text-sm font-medium text-gray-600 dark:text-gray-400">记住我</span>
              </label>
