  ...
  return (
    ...
    >
      ...
      >
        ...
        {isTopSlowest && <Zap className="h-3 w-3 text-amber-500 shrink-0" />}
      </div>
...
export function RagTraceDetailPage() {
  ...
  const stats = useMemo(() => {
    ...
    const sortedByDuration = [...nodes].sort(
      (a, b) => resolveNodeDuration(b) - resolveNodeDuration(a)
    );
    ...
    <div className="space-y-4 pb-8">
      ...
      <Card>
        <CardHeader className="py-3 px-4">
          <div className="flex items-center justify-between">
            <CardTitle className="text-sm font-medium text-slate-700">执行时序</CardTitle>
