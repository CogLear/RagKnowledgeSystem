  ...
  return (
    <Card className="trace-list-table-card">
      <div className="trace-list-table-header">
        ...
        <p className="trace-list-table-description">
                  ...
                  <TableRow key={run.traceId} className="trace-list-table-row">
                    <TableCell className="trace-col-trace">
                      <div className="trace-list-run-trace">
                        <p
                          className="trace-list-run-name line-clamp-1"
                          title={run.traceName || "-"}
                        >
                          {run.traceName || "-"}
                        </p>
                    ...
                    <TableCell className="trace-col-meta">
                      <p
                        className="trace-list-run-meta-line"
                        title={`会话ID: ${run.conversationId || "-"}`}
                      >
                        {run.conversationId || "-"}
                      </p>
                      <p
                        className="trace-list-run-meta-line is-secondary"
                        title={`TaskID: ${run.taskId || "-"}`}
                      >
                        {run.taskId || "-"}
                      </p>
                    </TableCell>
                    ...
                    <TableCell className="trace-col-status trace-list-status-cell">
                      <Badge
                        className="trace-list-status-badge"
