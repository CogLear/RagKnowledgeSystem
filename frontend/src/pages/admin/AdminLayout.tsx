    ...
    <div className="admin-layout flex h-screen">
      <aside className={cn("admin-sidebar", collapsed && "admin-sidebar--collapsed")}>
        <div className="admin-sidebar__brand">
          {collapsed ? (
            <div className="admin-sidebar__brand-collapsed">
              <button
                type="button"
                className="admin-sidebar__collapse-btn-only"
            ...
            <div className="admin-sidebar__brand-row">
              ...
              <div className="admin-sidebar__title-area">
                <h1 className="admin-sidebar__title">知识库管理后台</h1>
              ...
              return (
                ...
                >
                  ...
                  {collapsed ? (
                    ...
                    <span className="admin-sidebar__text-wrapper">
            ...
            if (collapsed) {
              ...
              return (
                <Link
                  ...
                  title={item.label}
                  className={cn(
                    "admin-sidebar__item admin-sidebar__item--group justify-center",
            ...
            return (
              <div key={item.label} className="space-y-1">
                <button
                  ...
                  onClick={() =>
                    setOpenGroups((prev) => ({
                      ingestion: item.id === "ingestion" ? !prev.ingestion : false,
                      intent: item.id === "intent" ? !prev.intent : false
                    }))
                  }
                  className={cn(
                ...
                >
                  ...
                  />
                  <item.icon className="admin-sidebar__item-icon" />
                  <span className="admin-sidebar__text-wrapper flex-1 text-left">
                    <span className="admin-sidebar__text">{item.label}</span>
                  </span>
                  {isOpen ? (
                ...
                <div
                  className={cn(
                    "ml-6 overflow-hidden transition-all duration-300 ease-out",
                    ...
                    {item.children.map((child) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="admin-sidebar__text-wrapper">
                            <span className="admin-sidebar__text">{child.label}</span>
                          </span>
                        </Link>
                      );
                    })}
