...
export function KnowledgeChunksPage() {
  ...
  return (
    <div className="admin-page">
        ...
        <CardHeader>
          <div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div className="flex flex-1 flex-wrap items-center justify-end gap-2">
              ...
              <Button variant="outline" onClick={() => setBatchAllAction("enable")}>
                全量启用
              </Button>
              <Button variant="outline" onClick={() => setBatchAllAction("disable")}>
                全量禁用
              </Button>
            </div>
          </div>
      ...
      <AlertDialog
        open={Boolean(batchAllAction)}
        onOpenChange={(open) => (!open ? setBatchAllAction(null) : null)}
      >
        <AlertDialogContent>
          <AlertDialogHeader>
