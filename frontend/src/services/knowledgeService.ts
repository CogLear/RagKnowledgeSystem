...
export const getKnowledgeBases = async (
  ...
  const page = await api.get<PageResult<KnowledgeBase>, PageResult<KnowledgeBase>>(
    "/knowledge-base",
    {
...
export const getDocumentsPage = async (
  ...
  return api.get<PageResult<KnowledgeDocument>, PageResult<KnowledgeDocument>>(
...
export const searchKnowledgeDocuments = async (
  ...
  return api.get<KnowledgeDocumentSearchItem[], KnowledgeDocumentSearchItem[]>(
...
export const uploadDocument = async (
  ...
  return api.post<KnowledgeDocument, KnowledgeDocument>(
...
export const batchEnableChunks = async (
  docId: string,
...
export const batchDisableChunks = async (
  docId: string,
  chunkIds?: Array<string | number>
): Promise<void> => {
